...
extension GameScene {
    func createBird() -> SKSpriteNode {
        //1
        let bird = SKSpriteNode(texture: SKTextureAtlas(named:"Assets").textureNamed("flappybird1"))
    ...
    func createRestartBtn() {
        restartBtn = SKSpriteNode(imageNamed: "flappyrestart")
    ...
    func createPauseBtn() {
        pauseBtn = SKSpriteNode(imageNamed: "flappypause")
    ...
    func createLogo() {
        ...
        logoImg = SKSpriteNode(imageNamed: "flappylogo")
    ...
    func createWalls() -> SKNode  {
        // 1
        let flowerNode = SKSpriteNode(imageNamed: "flappyflower")
        ...
        let topWall = SKSpriteNode(imageNamed: "flappypillar")
        let btmWall = SKSpriteNode(imageNamed: "flappypillar")
